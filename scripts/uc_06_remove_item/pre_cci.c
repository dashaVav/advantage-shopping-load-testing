# 1 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c"
...
# 1 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c" 2
...
# 2 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c" 2
...
# 3 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c" 2
...
# 4 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c" 2
...
Action()
{
	...
	lr_start_transaction("uc_04_add_to_card");
		...
		lr_start_transaction("open_main_page");
			...
			web_url("home-page.html", 
				...
				"LAST");
		lr_end_transaction("open_main_page", 2);
		...
		lr_end_transaction("search_request",2);
		...
		lr_end_transaction("open_search_page",2);
		...
		lr_end_transaction("open_item_page",2);
		...
		lr_end_transaction("add_to_card",2);
		...
		lr_start_transaction("open_card");
			...
			web_url("shoppingCart.html", 
				...
				"Mode=HTML", 
				"LAST");
		lr_end_transaction("open_card", 2);
		...
		lr_end_transaction("remove_item",2);
	...
	lr_end_transaction("uc_04_add_to_card", 2);

	return 0;
}
# 5 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c" 2
...
# 6 "c:\\users\\huawei\\documents\\advantage-shopping-load-testing\\scripts\\uc_06_remove_item\\\\combined_uc_06_remove_item.c" 2
